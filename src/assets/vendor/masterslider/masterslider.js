  ...
  p.locate = function () {
    ...
    if (this.slide.slider.options.responsive && this.relativeScale) {
      factor = this.resizeFactor =
        width / this.slide.slider.getBreakpointReferenceSize(); // this.slide.slider.options.width;
    } else {
    ...
    if (this.minWidth < width && this.slide.slider.options.responsive) {
      this.visible(
        this.hideOn.indexOf(this.slide.slider.getActiveBreakpoint()) === -1
      );
    }
  };
...
*/
  p.create = function () {
    ...
    this.point = $(
      '<div><div className="ms-point-center"></div><div className="ms-point-border"></div></div>'
    )
...
(function ($) {
  ...
  p.create = function () {
    _super.create.call(this);
    this.$element
      .wrap('<div className="ms-btn-container"></div>')
    ...
    if (this.video) {
      ...
      if (window._touch) {
        this.vcbtn
          ...
          .append('<div className="ms-vcbtn-txt">Close video</div>')
...
(function ($) {
  ...
  p.setupView = function () {
    ...
    if (viewClass._3dreq && (!window._css3d || window.MSBrowserInfo.msie))
...
(function ($) {
  ...
  p.getActiveBreakpoint = function (getIndex) {
    ...
    var currentSize =
      this.options.sizingReference === "self"
        ? this.$element.outerWidth(false)
        : window.innerWidth;
    var bp = "desktop";
    var bpIndex = 2;
...
(function ($) {
  ...
  p.slideAction = function (slide) {
    ...
    var thumb_frame = $("<div></div>")
      ...
      .append(thumb_ele)
      .append($('<div className="ms-thumb-ol"></div>'))
    ...
    for (var i = 0, l = slides.length; i !== l; i++) {
      ...
      if (slide.hasLayers) {
        slide.layerController.$layers.wrap(
          '<div className="ms-scroll-parallax-cont"></div>'
        );
